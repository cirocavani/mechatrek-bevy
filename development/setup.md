# Mechatrek Bevy - Development Setup

How to setup the development system based on Ubuntu Linux 26.04 Resolute.
...
And the build system is based on the following Docker images:

- X86_64 Ubuntu 26.04: [`docker/ubuntu/Dockerfile`](../docker/ubuntu/Dockerfile)
- Aarch64 Debian 13 (Target RPI): [`docker/debian/Dockerfile`](../docker/debian/Dockerfile)
